...
public class HotkeyDisplayComposite {
	...
	public HotkeyDisplayComposite(final Composite parent, Suggestion s, Display display) {
    	...
    	// Add lightbulb icon
    	Image image = new Image(display, this.getClass().getResourceAsStream("/resources/Lightbulb.jpeg"));
        CLabel hotkey = new CLabel(baseComposite, 0);
        hotkey.setImage(image);
        hotkey.setText(s.getText());

        // Add exit button
        Image exitButton = new Image(display, this.getClass().getResourceAsStream("/resources/ExitButton.png"));
